...
from .APIS import places,User_service,enterpreneur_service,searchEngine,tour_package_services ,smartTourguide_services,chatbot_service,recommendationEngine_services,rekoChatbot
...
app.include_router(rekoChatbot.app)
app.include_router(tour_package_services.app)